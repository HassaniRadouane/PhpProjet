<?php
    ...
    $tblDemo = new ajaxCRUD("Produits", "produit_panier", "Panier_idPanier", "");
    ...
    $tblDemo->defineRelationship("Panier_idPanier", "Panier", "idPanier", "idPanier"); //use your own table - this table (tblDemoRelationship) not included in the installation script
	$tblDemo->defineRelationship("Produit_idProducts", "Produit", "idProducts", "description");
    ...
    $tblDemo->omitField("Panier_idPanier");
    ...
    $tblDemo->addWhereClause("WHERE Panier_idPanier = $id");
...
?>
		<div style="float: left">
			Total produits dans le panier: <b><?php $tblDemo->insertRowsReturned();?></b><br />
		</div>
